public class WTF {
    ...
    public static void rebalance(WTF tree, Node node){
    ...
    public static void insert(WTF tree, Node node, int key) {
        if (key == node.key) {
    ...
    public static void delete(WTF tree, Node node){
    ...
    public WTF() {} // Dummy Constructor, no need to edit
}
